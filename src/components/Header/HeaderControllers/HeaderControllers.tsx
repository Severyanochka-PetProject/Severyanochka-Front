...
interface IHeaderControllers {
    showCatalogController?: boolean;
}

const HeaderControllers :FC<IHeaderControllers> = ({ showCatalogController = false, children }) => {
    ...
    return (
        <div className="header-wrapper__controllers">
            ...
            <Link to="/categories"
                  className={`controller-item ${location.pathname === '/categories' ? 'controller-item_active' : ''}`}>
            ...
            <Link to="/favorites" className="controller-item">
                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd"
            ...
            <Link to="/basket"
                  className={`controller-item ${location.pathname === '/basket' ? 'controller-item_active' : ''}`}>
