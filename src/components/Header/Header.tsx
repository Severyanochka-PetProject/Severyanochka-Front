...
const Header: FC = () => {
    ...
    const renderProfileBlock = () => {
        return <>
            {user.isAuth ? (
                <div
                    className={`header-wrapper__profile ${ isOpenDropMenu ? 'header-wrapper__profile_shadow' : '' }`}
                ...
                >
                    ...
                    <div className={`profile-arrow ${ isOpenDropMenu ? 'profile-arrow_rotate' : '' }`}>
                    ...
                    <div className={`profile-drop-list ${ isOpenDropMenu ? 'profile-drop-list_open' : '' }`}>
                        <ul>
                            <li>Профиль</li>
